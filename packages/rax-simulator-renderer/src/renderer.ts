...
function isValidDesignModeRaxComponentInstance(raxComponentInst: any): raxComponentInst is {
  props: {
...
function getRaxVDomParentInstance(instance: { _internal: any }) {
  ...
  return (
    internalInstance.__parentInstance ||
    Object.values(internalInstance).find(
      (v) =>
        v !== null &&
        v !== instance &&
        typeof v === 'object' &&
